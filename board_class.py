...
class board:
	...
	def is_blocked(vehicle_dict, df_grid):
		...
		if any("horizontal" in s for s in vehicle_dict):
			...
			left_grid = 0
			right_grid = 0
			# check left and right of the vehicle for other vehicles or wall
		...
		if any("vertical" in s for s in vehicle_dict):
			...
			up_grid = 0
			down_grid = 0
			# check above and below the vehicle for other vehicles or wall
